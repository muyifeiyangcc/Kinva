...
enum MockCatalog {
    ...
    static let challenges: [KinvaChallenge] = [
        KinvaChallenge(id: "seed-challenge-elena", authorID: "elena", title: "Stretch Performance", detail: "Can you do this? Join my Challenge and show your lines!", category: "Stretch Performance", mediaTokens: ["001.mp4"], diamondPrice: 300, likedBy: [], participantIDs: []),
        KinvaChallenge(id: "seed-challenge-marcus", authorID: "marcus", title: "Dance Flow", detail: "Match my rhythm! Join the dance flow challenge and share your movement.", category: "Dance Flow", mediaTokens: ["003.mp4"], diamondPrice: 300, likedBy: [], participantIDs: []),
        KinvaChallenge(id: "seed-challenge-claire", authorID: "claire", title: "Freestyle Movement", detail: "Think you can control this movement? Join the challenge and give it a try!", category: "Freestyle Movement", mediaTokens: ["009.mp4"], diamondPrice: 300, likedBy: [], participantIDs: []),
        KinvaChallenge(id: "seed-challenge-thorne", authorID: "thorne", title: "Stretch Performance", detail: "Take on this stretch routine challenge and let’s see your flexibility!", category: "Stretch Performance", mediaTokens: ["008.mp4"], diamondPrice: 0, likedBy: [], participantIDs: []),
        KinvaChallenge(id: "seed-challenge-hannah", authorID: "hannah", title: "Dance Flow", detail: "Show me your flow! Hop on this challenge and express your own dance vibes.", category: "Dance Flow", mediaTokens: ["006.mp4"], diamondPrice: 0, likedBy: [], participantIDs: []),
        KinvaChallenge(id: "seed-challenge-foster", authorID: "foster", title: "Freestyle Movement", detail: "Testing body control and balance today. Show me your best shot!", category: "Freestyle Movement", mediaTokens: ["004.mp4"], diamondPrice: 0, likedBy: [], participantIDs: []),
        KinvaChallenge(id: "seed-challenge-doris", authorID: "doris", title: "Stretch Performance", detail: "Can you reach this pose?", category: "Stretch Performance", mediaTokens: ["002.mp4"], diamondPrice: 0, likedBy: [], participantIDs: [])
    ]
